...
import { SiJavascript, SiReact, SiNodedotjs, SiPython, SiDocker, SiAmazonwebservices } from "react-icons/si";
    ...
    const highlights = [
        {
            ...
            description: "Expertise in both frontend and backend technologies, creating seamless end-to-end solutions."
        },
        {
            icon: HiCloud,
            title: "Cloud Computing",
            description: "Proficient in cloud platforms and services, designing scalable cloud-native applications."
        },
        {
            icon: HiDatabase,
            title: "Database Design",
            description: "Strong foundation in database analysis, design, and optimization for high-performance applications."
        },
        {
            icon: HiCog,
            title: "System Architecture",
            description: "Experience in designing and implementing scalable, maintainable software architectures."
        }
    ];
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-20">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-neutral-600 max-w-3xl mx-auto">
                        I'm a{" "}
                        <span className="text-primary-600 font-semibold">FullStack Developer</span>{" "}
                        with a passion for{" "}
                        <span className="text-secondary-600 font-semibold">Cloud Computing</span>
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-20">
                    ...
                    >
                        <div className="modern-card p-8">
                            <h2 className="text-2xl font-bold mb-4 text-neutral-900">My Story</h2>
                            <p className="text-neutral-700 leading-relaxed mb-4">
                                I am a highly motivated professional, known for my proactive approach and strong communication skills. I excel in meeting tight deadlines while consistently delivering high-quality software that adheres to CMMI standards.
                            </p>
                            <p className="text-neutral-700 leading-relaxed">
                                My strong foundation in Database Analysis & Design, coupled with a deep understanding of Object-Oriented Programming, enables me to design and implement scalable and maintainable solutions.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="modern-card p-8">
                            <h2 className="text-2xl font-bold mb-6 text-neutral-900">Technical Skills</h2>
                ...
                <motion.div
                    ...
                    className="mb-20"
                >
                    <h2 className="text-3xl font-bold text-center mb-12 text-neutral-900">What I Do Best</h2>
                ...
                >
                    <div className="modern-card p-8 max-w-2xl mx-auto">
                        <h2 className="text-2xl font-bold mb-4 text-neutral-900">Let's Work Together</h2>
